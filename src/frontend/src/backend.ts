...
import type { ExternalBlob as _ExternalBlob, HygieneVerdict as _HygieneVerdict, ScanRecord as _ScanRecord, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async analyzeAndStore(arg0: ExternalBlob, arg1: string): Promise<ScanRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeAndStore(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1);
                return from_candid_ScanRecord_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAllRecords(): Promise<Array<ScanRecord>> {
        if (this.processError) {
            try {
...
function from_candid_HygieneVerdict_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _HygieneVerdict): HygieneVerdict {
    return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_ScanRecord_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ScanRecord): Promise<ScanRecord> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        verdict: from_candid_HygieneVerdict_n11(_uploadFile, _downloadFile, value.verdict),
        score: value.score,
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "fair" in value ? HygieneVerdict.fair : "good" in value ? HygieneVerdict.good : "poor" in value ? HygieneVerdict.poor : "excellent" in value ? HygieneVerdict.excellent : value;
}
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ScanRecord>): Promise<Array<ScanRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ScanRecord_n9(_uploadFile, _downloadFile, x)));
}
